...
[1] 2216    5
str(data) 
'data.frame':	2216 obs. of  5 variables:
...
str(data) 
'data.frame':	2215 obs. of  5 variables:
...
"2010-05-14" "2018-06-07" "2021-03-12" "2020-08-05" "2023-09-09" "2026-04-01"
# No
...
str(spotprices) 
'data.frame':	2215 obs. of  2 variables:
 $ date : Date, format: "2010-05-14" "2010-05-21" ...
 $ price: num  17.8 17.5 17.5 17 17.8 ...
...
plot(monthprice,tck=0.01,xlab="",ylab="",ann=TRUE, las=1,col='red',lwd=1,type='l',lty=1)
points(monthprice,col='red',pch=19,cex=0.75)
grid(col="darkgray",lwd=1)
axis(side=4, tck=0.01, las=0,tick=TRUE,labels = FALSE)
mtext(side=1,cex=0.8,line=-1.1,"Data: 'NZU prices' https://github.com/theecanmole/nzu")
mtext(side=3,cex=1.5, line=-2.2,expression(paste("New Zealand Unit monthly mean prices 2010 - 2026")) )
...
labs(title="New Zealand Unit mean monthly prices 2010 - 2026", x ="Years", y ="Price $NZD", caption="Data: https://github.com/theecanmole/NZ-emission-unit-prices") +
...
str(spotpricealldates)
 Date[1:5802], format: "2010-05-14" "2010-05-15" "2010-05-16" "2010-05-17" "2010-05-18" ...
...
'data.frame':	5802 obs. of  2 variables:
...
‘zoo’ series from 2010-05-14 to 2026-04-01
  Data: num [1:5802] 17.8 NA NA NA NA ...
  Index:  Date[1:5802], format: "2010-05-14" "2010-05-15" "2010-05-16" "2010-05-17" "2010-05-18" ...
...
#2026-02-20 2026-02-21 2026-02-22 2026-02-23 2026-02-24 2026-02-25
     44.55      43.00      44.15      45.30      46.75      47.50
#2026-01-14 2026-01-15 2026-01-16 2026-01-17 2026-01-18 2026-01-19
#      35.6       35.0       33.2       33.4       33.6       33.6

str(spotpricefilled) 
‘zoo’ series from 2010-05-14 to 2026-04-01
  Data: num [1:5802] 17.8 17.7 17.7 17.6 17.6 ...
  Index:  Date[1:5802], format: "2010-05-14" "2010-05-15" "2010-05-16" "2010-05-17" "2010-05-18" ...
...
summary(spotpricefilleddataframe)
      date                price
 Min.   :2010-05-14   Min.   : 1.600
 1st Qu.:2014-05-03   1st Qu.: 8.557
 Median :2018-04-22   Median :21.250
 Mean   :2018-04-22   Mean   :29.931
 3rd Qu.:2022-04-11   3rd Qu.:50.500
 Max.   :2026-04-01   Max.   :88.500
...
str(spotpricefilleddataframe)
'data.frame':	4144 obs. of  4 variables:
 $ date       : Date, format: "2010-05-14" "2010-05-17" ...
 $ price      : num  17.8 17.6 17.6 17.6 17.5 ...
 $ day        : chr  "Friday" "Monday" "Tuesday" "Wednesday" ...
...
str(spotpricefilleddataframe)
'data.frame':	3968 obs. of  4 variables:
 $ date       : Date, format: "2010-05-14" "2010-05-17" ...
 $ price      : num  17.8 17.6 17.6 17.6 17.5 ...
 $ day        : chr  "Friday" "Monday" "Tuesday" "Wednesday" ...
 $ businessday: logi  TRUE TRUE TRUE TRUE TRUE TRUE ...
...
# create a second zoo series that has same nrow as 'spotpricefilleddataframe'
...
par(mar=c(2.7,2.7,1,1)+0.1)
plot(spotpricefilleddataframe[["date"]], spotpricefilleddataframe[["price"]] ,tck=0.01,ann=T, las=1,col="red",lwd=1,type='l',lty=1,xlab ="",ylab="")
grid(col="darkgray",lwd=1)
axis(side=4, tck=0.01, las=0,tick=TRUE,labels = FALSE)
mtext(side=1,cex=1,line=-1.1,"Data https://github.com/theecanmole/NZ-emission-unit-prices")
mtext(side=3,cex=1.6, line=-2.2,expression(paste("New Zealand Unit spot prices 2010 to 2026")) )
...
hjust = 0.5, vjust= -8 ),
plot.caption = element_text( hjust = 0.5 )) +
labs(title="New Zealand Unit spot prices 2010 to 2026", x ="Years", y ="Price $NZD", caption="Data: https://github.com/theecanmole/NZ-emission-unit-prices") +
...
str(spotroll31)
‘zoo’ series from 2010-05-14 to 2026-04-01
  Data: num [1:3968] NA NA NA NA NA NA NA NA NA NA ...
  Index:  Date[1:3968], format: "2010-05-14" "2010-05-17" "2010-05-18" "2010-05-19" "2010-05-20" ..
...
summary(spotroll31)
 ...
 1st Qu.:2014-04-30   1st Qu.: 8.453
 Median :2018-04-18   Median :21.245
 Mean   :2018-04-17   Mean   :29.895
 3rd Qu.:2022-04-05   3rd Qu.:51.079
 Max.   :2026-04-01   Max.   :86.946
                      NAs   :20
# 10 NAs at beginning and 10 at end so that's ok
...
'data.frame':	3968 obs. of  2 variables:
 $ date : Date, format: "2010-05-14" "2010-05-17" ...
...
summary(spotroll31dataframe)
 ...
 1st Qu.:2014-04-19   1st Qu.: 8.16
 Median :2018-03-29   Median :21.19
 Mean   :2018-03-30   Mean   :29.81
 3rd Qu.:2022-03-09   3rd Qu.:51.26
 Max.   :2026-02-25   Max.   :86.95
                      NAs   :20

# NB ten NAs at start and ten NAs at end which is expected in a rolling mean series
...
theme_bw(base_size = 14) +
	...
	hjust = 0.5, vjust= -8 ),
	plot.caption = element_text( hjust = 0.5 )) +
labs(title="New Zealand Unit rolling mean spot prices 2010 to 2026", x ="Years", y ="Price $NZD", caption="Data: https://github.com/theecanmole/NZ-emission-unit-prices") +
...
‘zoo’ series from 2010-05-10 to 2025-12-15
  Data: num [1:830] 17.8 17.6 17.5 17.3 17.1 ...
  Index:  Date[1:830], format: "2010-05-10" "2010-05-17" "2010-05-24" "2010-05-31" "2010-06-07" ...

# round to cents i.e 2 decimal places
coredata(weekpricezoo) <- round(coredata(weekpricezoo),2)
summary(coredata(weekpricezoo))
   Min. 1st Qu.  Median    Mean 3rd Qu.    Max.
   1.64    8.55   21.25   29.85   50.92   88.24
...
# subset only the date and price
...
# This is a chart of 2025 prices using the infilled spot price data in the Ggplot2 theme 'black and white' with x axis at $10 and y axis at 1 year
...
[1] qlcal_0.0.17  zoo_1.8-15    ggplot2_4.0.1 rkward_0.7.5

loaded via a namespace (and not attached):
 [1] Rcpp_1.1.1         lattice_0.22-7     withr_3.0.2        dplyr_1.1.4
 [5] grid_4.2.2         R6_2.5.1           lifecycle_1.0.3    gtable_0.3.6
 [9] magrittr_2.0.3     scales_1.4.0       pillar_1.11.1      rlang_1.1.7
[13] cli_3.5.0          farver_2.1.2       vctrs_0.7.1        generics_0.1.4
[17] RColorBrewer_1.1-3 tools_4.2.2        S7_0.2.1           glue_1.6.2
[21] compiler_4.2.2     pkgconfig_2.0.3    tidyselect_1.2.1   tibble_3.3.1

# session information until 31/12/2025
sessionInfo()
